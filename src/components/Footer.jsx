...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-forest text-brand-offwhite dark:bg-brand-maroon-deep border-t border-brand-sage/10 pt-16 pb-8 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            {[
              {
                icon: FaFacebookF,
                href: "https://www.facebook.com/p/Gyan-Mandir-Yog-Center-100075722265452/",
                label: "Facebook"
              },
              {
                icon: FaInstagram,
        ...
        {/* Quick Links */}
        <div>
          <h4 className="font-serif text-lg font-semibold text-brand-sage mb-5">
            Quick Links
          </h4>
          ...
          <ul className="space-y-2.5 text-sm text-brand-beige/85">
            {[
              ...
              <li key={idx}>
                ...
                >
                  <span className="text-xs text-brand-sage/50">✦</span>
                  {link.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-brand-beige/85 font-light">
            <li className="flex items-start gap-3">
              ...
              <a
                href="https://www.google.com/maps/search/?api=1&query=Gyan+Mandir+Yog+Center+Aapgachi+Itahari+Nepal"
                target="_blank"
                rel="noreferrer"
            ...
            <li className="flex items-center gap-3">
              ...
              <span>Phone number not publicly verified</span>
            </li>

            <li className="flex items-center gap-3">
              <FiMail className="w-5 h-5 text-brand-sage shrink-0" />
              <span>Email not publicly verified</span>
            </li>

            <li className="flex items-center gap-3">
              <FaFacebookF className="w-5 h-5 text-brand-sage shrink-0" />
              <a
                href="https://www.facebook.com/p/Gyan-Mandir-Yog-Center-100075722265452/"
                target="_blank"
                rel="noreferrer"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-brand-sage/10 flex flex-col sm:flex-row items-center justify-between text-xs text-brand-beige/65 gap-4">
        <div>
          © {new Date().getFullYear()} Gyan Mandir . All rights reserved.
        </div>
